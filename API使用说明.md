...
```bash
go get -u github.com/WitcHer-r/gmsm
```
...
- go package： `github.com/WitcHer-r/gmsm/sm2`
...
- g package：`github.com/WitcHer-r/gmsm/sm3`
...
- go package：`github.com/WitcHer-r/gmsm/sm4`

### 代码示例

```Go
    import  "crypto/cipher"
    import  "github.com/WitcHer-r/gmsm/sm4"
    import "fmt"
...
### 具体功能测试代码参考
```Go
github.com/WitcHer-r/gmsm/sm2/sm2_test.go  //sm2算法
github.com/WitcHer-r/gmsm/sm3/sm3_test.go  //sm3算法
github.com/WitcHer-r/gmsm/sm4/sm4_test.go  //sm4算法
github.com/WitcHer-r/gmsm/x509/x509_test.go //x509国密证书
github.com/WitcHer-r/gmsm/gmtls/gmcredentials/credentials_test.go  //国密tls
```